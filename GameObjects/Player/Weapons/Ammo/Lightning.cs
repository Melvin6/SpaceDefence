...
{
    internal class Lightning : Ammo
    {

        public Lightning(Vector2 location, Vector2 target, Vector2 direction) : base (new LinePieceCollider(location,  target), Vector2.Zero, 0.25f)
